...
import com.example.whatdoing.data.util.ImageSaver
import com.example.whatdoing.domain.usecase.GetDailyExtractUseCase
...
class ExtractViewModel @Inject constructor(
    ...
    private fun save(bitmap: android.graphics.Bitmap) {
        ...
        viewModelScope.launch {
            val fileName = "helpmuta_${System.currentTimeMillis()}"
